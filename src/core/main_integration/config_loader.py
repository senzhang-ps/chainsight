...
def load_configuration(config) -> dict[str, pd.DataFrame]:
    """Load raw configuration tables from Excel and same-directory CSV files."""
    cfg_dir = _coerce_config_dir(config)
    logger.info(

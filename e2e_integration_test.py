    ...
    def create_test_configuration(self) -> str:
        ...
        config_data = {
            ...
            'M4_MaterialLocationLineCfg': pd.DataFrame([
                {'material': 'MAT_A', 'location': 'PLANT_001', 'delegate_line': 'LINE_A', 'prd_rate': 80, 'min_batch': 20, 'rv': 10, 'lsk': 1, 'ptf': 1, 'day': 1, 'MCT': 1},
                {'material': 'MAT_B', 'location': 'PLANT_001', 'delegate_line': 'LINE_B', 'prd_rate': 60, 'min_batch': 15, 'rv': 8, 'lsk': 1, 'ptf': 1, 'day': 1, 'MCT': 1}
            ]),

...
| **Src** | 2886秒 (48.1分钟) | 288.6秒 |
| **DB** | 1338秒 (22.3分钟) | 133.8秒 |

### 2.2 性能提升比例
| 对比项 | 加速倍数 | 时间减少百分比 |
|--------|----------|----------------|
| **Src vs Dev** | **4.42x** | 77.4% |
| **DB vs Dev** | **9.53x** | 89.5% |
| **DB vs Src** | **2.16x** | 53.6% |

### 2.3 各模块平均耗时对比（秒/天）
| 模块 | Dev | Src | DB | Src加速 | DB加速 |
|------|-----|-----|-----|---------|--------|
| **M1 订单生成** | ~387.8 | ~48.2 | ~47.8 | 8.05x | 8.11x |
| **M3 净需求计算** | ~333.1 | ~55.8 | ~26.2 | 5.97x | 12.71x |
| **M5 部署规划** | ~550.8 | ~182.3 | ~57.5 | 3.02x | 9.58x |

### 2.4 每日详细耗时（区间最后一天）
#### Day 10 (2025-12-24) 各模块耗时（秒）
| 模块 | Dev | Src | DB |
|------|-----|-----|-----|
| M1 订单生成 | ~404.0 | ~54.0 | ~53.0 |
| M3 净需求计算 | ~355.0 | ~58.0 | ~26.0 |
| M5 部署规划 | ~588.0 | ~194.0 | ~64.0 |
| M6 物流执行 | ~3.0 | ~1.0 | ~2.0 |
...
|------|------|---------|---------|--------|------------|-----------|-----------|
| Module1 | 订单日志 (OrderLog) | 134,393 | 134,393 | 134,393 | PASS | PASS | PASS |
...
| Day 02 | 2025-12-16 | 7,900 | 7,900 | 7,900 | PASS | PASS | PASS |
| Day 03 | 2025-12-17 | 10,777 | 10,777 | 10,777 | PASS | PASS | PASS |
| Day 04 | 2025-12-18 | 13,019 | 13,019 | 13,019 | PASS | PASS | PASS |
| Day 05 | 2025-12-19 | 14,623 | 14,623 | 14,623 | PASS | PASS | PASS |
| Day 06 | 2025-12-20 | 15,669 | 15,669 | 15,669 | PASS | PASS | PASS |
| Day 07 | 2025-12-21 | 16,389 | 16,389 | 16,389 | PASS | PASS | PASS |
| Day 08 | 2025-12-22 | 16,866 | 16,866 | 16,866 | PASS | PASS | PASS |
| Day 09 | 2025-12-23 | 17,179 | 17,179 | 17,179 | PASS | PASS | PASS |
| Day 10 | 2025-12-24 | 17,439 | 17,439 | 17,439 | PASS | PASS | PASS |
| **合计** | | **134,393** | **134,393** | **134,393** | **10/10天PASS** | **10/10天PASS** | **10/10天PASS** |
...
验证覆盖（本区间）：
- Module1 / 订单日志 (OrderLog): 134,393行 (Dev vs Src PASS, Dev vs DB PASS, Src vs DB PASS)
...
| 指标 | Dev | Src | DB | 最佳提升 |
|------|-----|-----|-----|----------|
| 区间总时间 | 212.6分钟 | 48.1分钟 | 22.3分钟 | 89.5% |
| M1 订单生成平均耗时/天 | ~387.8秒 | ~48.2秒 | ~47.8秒 | 87.7% |
| M3 净需求计算平均耗时/天 | ~333.1秒 | ~55.8秒 | ~26.2秒 | 92.1% |
| M5 部署规划平均耗时/天 | ~550.8秒 | ~182.3秒 | ~57.5秒 | 89.6% |

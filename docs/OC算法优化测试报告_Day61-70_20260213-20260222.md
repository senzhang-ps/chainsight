...
| **DB** | 1591秒 (26.5分钟) | 159.1秒 |

### 2.2 性能提升比例
| 对比项 | 加速倍数 | 时间减少百分比 |
|--------|----------|----------------|
| **Src vs Dev** | **4.06x** | 75.4% |
| **DB vs Dev** | **7.69x** | 87.0% |
| **DB vs Src** | **1.90x** | 47.2% |

### 2.3 各模块平均耗时对比（秒/天）
| 模块 | Dev | Src | DB | Src加速 | DB加速 |
|------|-----|-----|-----|---------|--------|
| **M1 订单生成** | ~344.4 | ~63.9 | ~65.6 | 5.39x | 5.25x |
| **M3 净需求计算** | ~336.3 | ~56.5 | ~27.2 | 5.95x | 12.36x |
| **M5 部署规划** | ~518.0 | ~165.4 | ~51.8 | 3.13x | 10.00x |

### 2.4 每日详细耗时（区间最后一天）
#### Day 70 (2026-02-22) 各模块耗时（秒）
| 模块 | Dev | Src | DB |
|------|-----|-----|-----|
| M1 订单生成 | ~365.0 | ~64.0 | ~65.0 |
| M3 净需求计算 | ~333.0 | ~55.0 | ~26.0 |
| M5 部署规划 | ~501.0 | ~164.0 | ~50.0 |
| M6 物流执行 | ~2.0 | ~2.0 | ~1.0 |
...
|------|------|---------|---------|--------|------------|-----------|-----------|
| Module1 | 订单日志 (OrderLog) | 176,343 | 176,343 | 176,343 | PASS | PASS | PASS |
| Module1 | 发货日志 (ShipmentLog) | 20,453 | 20,453 | 20,453 | PASS | PASS | PASS |
| Module1 | 削减日志 (CutLog) | 20,453 | 20,453 | 20,453 | PASS | PASS | PASS |
| Module1 | 每日汇总 (Summary) | 10 | 10 | 10 | PASS | PASS | PASS |
| Module3 | 净需求 (NetDemand) | 7,697 | 7,697 | 7,697 | PASS | PASS | PASS |
| Module4 | 生产计划 (ProductionPlan) | 83 | 83 | 83 | PASS | PASS | PASS |
| Module4 | 超容量报告 (CapacityExceed) | 76 | 76 | 76 | PASS | PASS | PASS |
| Module4 | 换型日志 (ChangeoverLog) | 62 | 62 | 62 | PASS | PASS | PASS |
| Module5 | 部署计划 (DeploymentPlan) | 410,179 | 410,179 | 410,179 | PASS | PASS | PASS |
| Module5 | 未满足日志 (UnfulfilledLog) | 18,799 | 18,799 | 18,799 | PASS | PASS | PASS |
| Module5 | 库存日志 (StockOnHandLog) | 51,090 | 51,090 | 51,090 | PASS | PASS | PASS |
| Module5 | 验证 (Validation) | 82,000 | 82,000 | 82,000 | PASS | PASS | PASS |
| Module6 | 交付计划 (DeliveryPlan) | 6,448 | 6,448 | 6,448 | PASS | PASS | PASS |
| Module6 | 车辆日志 (VehicleLog) | 89 | 89 | 89 | PASS | PASS | PASS |
| Module6 | 卡车使用日志 (TruckUsageLog) | 86 | 86 | 86 | PASS | PASS | PASS |
...
|------|------|---------|---------|--------|------------|-----------|-----------|
| Day 61 | 2026-02-13 | 17,556 | 17,556 | 17,556 | PASS | PASS | PASS |
| Day 62 | 2026-02-14 | 17,555 | 17,555 | 17,555 | PASS | PASS | PASS |
| Day 63 | 2026-02-15 | 17,555 | 17,555 | 17,555 | PASS | PASS | PASS |
| Day 64 | 2026-02-16 | 17,555 | 17,555 | 17,555 | PASS | PASS | PASS |
| Day 65 | 2026-02-17 | 17,687 | 17,687 | 17,687 | PASS | PASS | PASS |
| Day 66 | 2026-02-18 | 17,687 | 17,687 | 17,687 | PASS | PASS | PASS |
| Day 67 | 2026-02-19 | 17,687 | 17,687 | 17,687 | PASS | PASS | PASS |
| Day 68 | 2026-02-20 | 17,687 | 17,687 | 17,687 | PASS | PASS | PASS |
| Day 69 | 2026-02-21 | 17,687 | 17,687 | 17,687 | PASS | PASS | PASS |
| Day 70 | 2026-02-22 | 17,687 | 17,687 | 17,687 | PASS | PASS | PASS |
| **合计** | | **176,343** | **176,343** | **176,343** | **10/10天PASS** | **10/10天PASS** | **10/10天PASS** |
...
| **合计** | | **20,453** | **20,453** | **20,453** | **10/10天PASS** | **10/10天PASS** | **10/10天PASS** |
...
| **合计** | | **7,697** | **7,697** | **7,697** | **10/10天PASS** | **10/10天PASS** | **10/10天PASS** |
...
| **合计** | | **76** | **76** | **76** | **10/10天PASS** | **10/10天PASS** | **10/10天PASS** |
...
| **合计** | | **62** | **62** | **62** | **10/10天PASS** | **10/10天PASS** | **10/10天PASS** |
...
| **合计** | | **410,179** | **410,179** | **410,179** | **10/10天PASS** | **10/10天PASS** | **10/10天PASS** |
...
| **合计** | | **18,799** | **18,799** | **18,799** | **10/10天PASS** | **10/10天PASS** | **10/10天PASS** |
...
| **合计** | | **51,090** | **51,090** | **51,090** | **10/10天PASS** | **10/10天PASS** | **10/10天PASS** |
...
| **合计** | | **6,448** | **6,448** | **6,448** | **10/10天PASS** | **10/10天PASS** | **10/10天PASS** |
...
| **合计** | | **89** | **89** | **89** | **10/10天PASS** | **10/10天PASS** | **10/10天PASS** |
...
| Day 69 | 2026-02-21 | 10 | 10 | 10 | PASS | PASS | PASS |
| Day 70 | 2026-02-22 | 7 | 7 | 7 | PASS | PASS | PASS |
| **合计** | | **86** | **86** | **86** | **10/10天PASS** | **10/10天PASS** | **10/10天PASS** |
...
验证覆盖（本区间）：
- Module1 / 订单日志 (OrderLog): 176,343行 (Dev vs Src PASS, Dev vs DB PASS, Src vs DB PASS)
- Module1 / 发货日志 (ShipmentLog): 20,453行 (Dev vs Src PASS, Dev vs DB PASS, Src vs DB PASS)
- Module1 / 削减日志 (CutLog): 20,453行 (Dev vs Src PASS, Dev vs DB PASS, Src vs DB PASS)
- Module1 / 每日汇总 (Summary): 10行 (Dev vs Src PASS, Dev vs DB PASS, Src vs DB PASS)
- Module3 / 净需求 (NetDemand): 7,697行 (Dev vs Src PASS, Dev vs DB PASS, Src vs DB PASS)
- Module4 / 生产计划 (ProductionPlan): 83行 (Dev vs Src PASS, Dev vs DB PASS, Src vs DB PASS)
- Module4 / 超容量报告 (CapacityExceed): 76行 (Dev vs Src PASS, Dev vs DB PASS, Src vs DB PASS)
- Module4 / 换型日志 (ChangeoverLog): 62行 (Dev vs Src PASS, Dev vs DB PASS, Src vs DB PASS)
- Module5 / 部署计划 (DeploymentPlan): 410,179行 (Dev vs Src PASS, Dev vs DB PASS, Src vs DB PASS)
- Module5 / 未满足日志 (UnfulfilledLog): 18,799行 (Dev vs Src PASS, Dev vs DB PASS, Src vs DB PASS)
- Module5 / 库存日志 (StockOnHandLog): 51,090行 (Dev vs Src PASS, Dev vs DB PASS, Src vs DB PASS)
- Module5 / 验证 (Validation): 82,000行 (Dev vs Src PASS, Dev vs DB PASS, Src vs DB PASS)
- Module6 / 交付计划 (DeliveryPlan): 6,448行 (Dev vs Src PASS, Dev vs DB PASS, Src vs DB PASS)
- Module6 / 车辆日志 (VehicleLog): 89行 (Dev vs Src PASS, Dev vs DB PASS, Src vs DB PASS)
- Module6 / 卡车使用日志 (TruckUsageLog): 86行 (Dev vs Src PASS, Dev vs DB PASS, Src vs DB PASS)

### 5.2 区间性能总结
| 指标 | Dev | Src | DB | 最佳提升 |
|------|-----|-----|-----|----------|
| 区间总时间 | 203.9分钟 | 50.2分钟 | 26.5分钟 | 87.0% |
| M1 订单生成平均耗时/天 | ~344.4秒 | ~63.9秒 | ~65.6秒 | 81.4% |
| M3 净需求计算平均耗时/天 | ~336.3秒 | ~56.5秒 | ~27.2秒 | 91.9% |
| M5 部署规划平均耗时/天 | ~518.0秒 | ~165.4秒 | ~51.8秒 | 90.0% |

...
| **DB vs Dev** | **7.85x** | 87.3% |
| **DB vs Src** | **1.88x** | 46.9% |

### 2.3 各模块平均耗时对比（秒/天）
| 模块 | Dev | Src | DB | Src加速 | DB加速 |
|------|-----|-----|-----|---------|--------|
| **M1 订单生成** | ~381.2 | ~62.5 | ~64.2 | 6.10x | 5.94x |
| **M3 净需求计算** | ~344.8 | ~56.3 | ~26.8 | 6.12x | 12.87x |
| **M5 部署规划** | ~537.6 | ~171.4 | ~55.9 | 3.14x | 9.62x |
...
| Module1 | 发货日志 (ShipmentLog) | 20,944 | 20,944 | 20,944 | PASS | PASS | PASS |
| Module1 | 削减日志 (CutLog) | 20,944 | 20,944 | 20,944 | PASS | PASS | PASS |
| Module1 | 每日汇总 (Summary) | 10 | 10 | 10 | PASS | PASS | PASS |
| Module3 | 净需求 (NetDemand) | 10,443 | 10,443 | 10,443 | PASS | PASS | PASS |
| Module4 | 生产计划 (ProductionPlan) | 93 | 93 | 93 | PASS | PASS | PASS |
| Module4 | 超容量报告 (CapacityExceed) | 143 | 143 | 143 | PASS | PASS | PASS |
| Module4 | 换型日志 (ChangeoverLog) | 65 | 65 | 65 | PASS | PASS | PASS |
| Module5 | 部署计划 (DeploymentPlan) | 437,971 | 437,971 | 437,971 | PASS | PASS | PASS |
| Module5 | 未满足日志 (UnfulfilledLog) | 48,927 | 48,927 | 48,927 | PASS | PASS | PASS |
| Module5 | 库存日志 (StockOnHandLog) | 51,069 | 51,069 | 51,069 | PASS | PASS | PASS |
| Module5 | 验证 (Validation) | 82,000 | 82,000 | 82,000 | PASS | PASS | PASS |
| Module6 | 交付计划 (DeliveryPlan) | 12,914 | 12,914 | 12,914 | PASS | PASS | PASS |
| Module6 | 车辆日志 (VehicleLog) | 131 | 131 | 131 | PASS | PASS | PASS |
...
|------|------|---------|---------|--------|------------|-----------|-----------|
| Day 41 | 2026-01-24 | 17,689 | 17,689 | 17,689 | PASS | PASS | PASS |
| Day 42 | 2026-01-25 | 17,689 | 17,689 | 17,689 | PASS | PASS | PASS |
| Day 43 | 2026-01-26 | 17,689 | 17,689 | 17,689 | PASS | PASS | PASS |
| Day 44 | 2026-01-27 | 17,681 | 17,681 | 17,681 | PASS | PASS | PASS |
| Day 45 | 2026-01-28 | 17,681 | 17,681 | 17,681 | PASS | PASS | PASS |
| Day 46 | 2026-01-29 | 17,681 | 17,681 | 17,681 | PASS | PASS | PASS |
| Day 47 | 2026-01-30 | 17,681 | 17,681 | 17,681 | PASS | PASS | PASS |
| Day 48 | 2026-01-31 | 17,681 | 17,681 | 17,681 | PASS | PASS | PASS |
| Day 49 | 2026-02-01 | 17,681 | 17,681 | 17,681 | PASS | PASS | PASS |
| Day 50 | 2026-02-02 | 17,681 | 17,681 | 17,681 | PASS | PASS | PASS |
...
| **合计** | | **20,944** | **20,944** | **20,944** | **10/10天PASS** | **10/10天PASS** | **10/10天PASS** |
...
| **合计** | | **10,443** | **10,443** | **10,443** | **10/10天PASS** | **10/10天PASS** | **10/10天PASS** |
...
| **合计** | | **93** | **93** | **93** | **10/10天PASS** | **10/10天PASS** | **10/10天PASS** |
...
| **合计** | | **143** | **143** | **143** | **10/10天PASS** | **10/10天PASS** | **10/10天PASS** |
...
| **合计** | | **437,971** | **437,971** | **437,971** | **10/10天PASS** | **10/10天PASS** | **10/10天PASS** |
...
| **合计** | | **48,927** | **48,927** | **48,927** | **10/10天PASS** | **10/10天PASS** | **10/10天PASS** |
...
| **合计** | | **51,069** | **51,069** | **51,069** | **10/10天PASS** | **10/10天PASS** | **10/10天PASS** |
...
| **合计** | | **12,914** | **12,914** | **12,914** | **10/10天PASS** | **10/10天PASS** | **10/10天PASS** |
...
| **合计** | | **131** | **131** | **131** | **10/10天PASS** | **10/10天PASS** | **10/10天PASS** |
...
- Module1 / 发货日志 (ShipmentLog): 20,944行 (Dev vs Src PASS, Dev vs DB PASS, Src vs DB PASS)
- Module1 / 削减日志 (CutLog): 20,944行 (Dev vs Src PASS, Dev vs DB PASS, Src vs DB PASS)
- Module1 / 每日汇总 (Summary): 10行 (Dev vs Src PASS, Dev vs DB PASS, Src vs DB PASS)
- Module3 / 净需求 (NetDemand): 10,443行 (Dev vs Src PASS, Dev vs DB PASS, Src vs DB PASS)
- Module4 / 生产计划 (ProductionPlan): 93行 (Dev vs Src PASS, Dev vs DB PASS, Src vs DB PASS)
- Module4 / 超容量报告 (CapacityExceed): 143行 (Dev vs Src PASS, Dev vs DB PASS, Src vs DB PASS)
- Module4 / 换型日志 (ChangeoverLog): 65行 (Dev vs Src PASS, Dev vs DB PASS, Src vs DB PASS)
- Module5 / 部署计划 (DeploymentPlan): 437,971行 (Dev vs Src PASS, Dev vs DB PASS, Src vs DB PASS)
- Module5 / 未满足日志 (UnfulfilledLog): 48,927行 (Dev vs Src PASS, Dev vs DB PASS, Src vs DB PASS)
- Module5 / 库存日志 (StockOnHandLog): 51,069行 (Dev vs Src PASS, Dev vs DB PASS, Src vs DB PASS)
- Module5 / 验证 (Validation): 82,000行 (Dev vs Src PASS, Dev vs DB PASS, Src vs DB PASS)
- Module6 / 交付计划 (DeliveryPlan): 12,914行 (Dev vs Src PASS, Dev vs DB PASS, Src vs DB PASS)
- Module6 / 车辆日志 (VehicleLog): 131行 (Dev vs Src PASS, Dev vs DB PASS, Src vs DB PASS)
- Module6 / 卡车使用日志 (TruckUsageLog): 130行 (Dev vs Src PASS, Dev vs DB PASS, Src vs DB PASS)

### 5.2 区间性能总结
| 指标 | Dev | Src | DB | 最佳提升 |
|------|-----|-----|-----|----------|
| 区间总时间 | 215.5分钟 | 51.7分钟 | 27.4分钟 | 87.3% |
| M1 订单生成平均耗时/天 | ~381.2秒 | ~62.5秒 | ~64.2秒 | 83.6% |
| M3 净需求计算平均耗时/天 | ~344.8秒 | ~56.3秒 | ~26.8秒 | 92.2% |
| M5 部署规划平均耗时/天 | ~537.6秒 | ~171.4秒 | ~55.9秒 | 89.6% |

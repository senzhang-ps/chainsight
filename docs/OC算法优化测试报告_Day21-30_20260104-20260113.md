...
| **DB vs Src** | **1.91x** | 47.6% |

### 2.3 各模块平均耗时对比（秒/天）
| 模块 | Dev | Src | DB | Src加速 | DB加速 |
|------|-----|-----|-----|---------|--------|
| **M1 订单生成** | ~387.1 | ~62.2 | ~64.2 | 6.22x | 6.03x |
| **M3 净需求计算** | ~347.1 | ~57.8 | ~27.5 | 6.01x | 12.62x |
| **M5 部署规划** | ~564.2 | ~186.2 | ~65.0 | 3.03x | 8.68x |

### 2.4 每日详细耗时（区间最后一天）
#### Day 30 (2026-01-13) 各模块耗时（秒）
| 模块 | Dev | Src | DB |
|------|-----|-----|-----|
| M1 订单生成 | ~376.0 | ~63.0 | ~63.0 |
| M3 净需求计算 | ~342.0 | ~57.0 | ~28.0 |
...
|------|------|---------|---------|--------|------------|-----------|-----------|
| Module1 | 订单日志 (OrderLog) | 176,834 | 176,834 | 176,834 | PASS | PASS | PASS |
| Module1 | 发货日志 (ShipmentLog) | 20,952 | 20,952 | 20,952 | PASS | PASS | PASS |
| Module1 | 削减日志 (CutLog) | 20,952 | 20,952 | 20,952 | PASS | PASS | PASS |
| Module1 | 每日汇总 (Summary) | 10 | 10 | 10 | PASS | PASS | PASS |
| Module3 | 净需求 (NetDemand) | 16,859 | 16,859 | 16,859 | PASS | PASS | PASS |
| Module4 | 生产计划 (ProductionPlan) | 111 | 111 | 111 | PASS | PASS | PASS |
| Module4 | 超容量报告 (CapacityExceed) | 449 | 449 | 449 | PASS | PASS | PASS |
| Module4 | 换型日志 (ChangeoverLog) | 90 | 90 | 90 | PASS | PASS | PASS |
| Module5 | 部署计划 (DeploymentPlan) | 475,209 | 475,209 | 475,209 | PASS | PASS | PASS |
| Module5 | 未满足日志 (UnfulfilledLog) | 115,052 | 115,052 | 115,052 | PASS | PASS | PASS |
| Module5 | 库存日志 (StockOnHandLog) | 50,978 | 50,978 | 50,978 | PASS | PASS | PASS |
| Module5 | 验证 (Validation) | 82,000 | 82,000 | 82,000 | PASS | PASS | PASS |
| Module6 | 交付计划 (DeliveryPlan) | 14,063 | 14,063 | 14,063 | PASS | PASS | PASS |
| Module6 | 车辆日志 (VehicleLog) | 134 | 134 | 134 | PASS | PASS | PASS |
| Module6 | 卡车使用日志 (TruckUsageLog) | 132 | 132 | 132 | PASS | PASS | PASS |
...
|------|------|---------|---------|--------|------------|-----------|-----------|
| Day 21 | 2026-01-04 | 17,685 | 17,685 | 17,685 | PASS | PASS | PASS |
| Day 22 | 2026-01-05 | 17,635 | 17,635 | 17,635 | PASS | PASS | PASS |
| Day 23 | 2026-01-06 | 17,689 | 17,689 | 17,689 | PASS | PASS | PASS |
| Day 24 | 2026-01-07 | 17,689 | 17,689 | 17,689 | PASS | PASS | PASS |
| Day 25 | 2026-01-08 | 17,689 | 17,689 | 17,689 | PASS | PASS | PASS |
| Day 26 | 2026-01-09 | 17,689 | 17,689 | 17,689 | PASS | PASS | PASS |
| Day 27 | 2026-01-10 | 17,689 | 17,689 | 17,689 | PASS | PASS | PASS |
| Day 28 | 2026-01-11 | 17,689 | 17,689 | 17,689 | PASS | PASS | PASS |
| Day 29 | 2026-01-12 | 17,689 | 17,689 | 17,689 | PASS | PASS | PASS |
| Day 30 | 2026-01-13 | 17,691 | 17,691 | 17,691 | PASS | PASS | PASS |
| **合计** | | **176,834** | **176,834** | **176,834** | **10/10天PASS** | **10/10天PASS** | **10/10天PASS** |
...
| **合计** | | **20,952** | **20,952** | **20,952** | **10/10天PASS** | **10/10天PASS** | **10/10天PASS** |
...
| **合计** | | **16,859** | **16,859** | **16,859** | **10/10天PASS** | **10/10天PASS** | **10/10天PASS** |
...
| **合计** | | **111** | **111** | **111** | **10/10天PASS** | **10/10天PASS** | **10/10天PASS** |
...
| **合计** | | **449** | **449** | **449** | **10/10天PASS** | **10/10天PASS** | **10/10天PASS** |
...
| **合计** | | **90** | **90** | **90** | **10/10天PASS** | **10/10天PASS** | **10/10天PASS** |
...
| **合计** | | **475,209** | **475,209** | **475,209** | **10/10天PASS** | **10/10天PASS** | **10/10天PASS** |
...
| **合计** | | **115,052** | **115,052** | **115,052** | **10/10天PASS** | **10/10天PASS** | **10/10天PASS** |
...
| **合计** | | **50,978** | **50,978** | **50,978** | **10/10天PASS** | **10/10天PASS** | **10/10天PASS** |
...
| **合计** | | **14,063** | **14,063** | **14,063** | **10/10天PASS** | **10/10天PASS** | **10/10天PASS** |
...
| **合计** | | **134** | **134** | **134** | **10/10天PASS** | **10/10天PASS** | **10/10天PASS** |
...
| Day 29 | 2026-01-12 | 16 | 16 | 16 | PASS | PASS | PASS |
| Day 30 | 2026-01-13 | 15 | 15 | 15 | PASS | PASS | PASS |
| **合计** | | **132** | **132** | **132** | **10/10天PASS** | **10/10天PASS** | **10/10天PASS** |
...
验证覆盖（本区间）：
- Module1 / 订单日志 (OrderLog): 176,834行 (Dev vs Src PASS, Dev vs DB PASS, Src vs DB PASS)
- Module1 / 发货日志 (ShipmentLog): 20,952行 (Dev vs Src PASS, Dev vs DB PASS, Src vs DB PASS)
- Module1 / 削减日志 (CutLog): 20,952行 (Dev vs Src PASS, Dev vs DB PASS, Src vs DB PASS)
- Module1 / 每日汇总 (Summary): 10行 (Dev vs Src PASS, Dev vs DB PASS, Src vs DB PASS)
- Module3 / 净需求 (NetDemand): 16,859行 (Dev vs Src PASS, Dev vs DB PASS, Src vs DB PASS)
- Module4 / 生产计划 (ProductionPlan): 111行 (Dev vs Src PASS, Dev vs DB PASS, Src vs DB PASS)
- Module4 / 超容量报告 (CapacityExceed): 449行 (Dev vs Src PASS, Dev vs DB PASS, Src vs DB PASS)
- Module4 / 换型日志 (ChangeoverLog): 90行 (Dev vs Src PASS, Dev vs DB PASS, Src vs DB PASS)
- Module5 / 部署计划 (DeploymentPlan): 475,209行 (Dev vs Src PASS, Dev vs DB PASS, Src vs DB PASS)
- Module5 / 未满足日志 (UnfulfilledLog): 115,052行 (Dev vs Src PASS, Dev vs DB PASS, Src vs DB PASS)
- Module5 / 库存日志 (StockOnHandLog): 50,978行 (Dev vs Src PASS, Dev vs DB PASS, Src vs DB PASS)
- Module5 / 验证 (Validation): 82,000行 (Dev vs Src PASS, Dev vs DB PASS, Src vs DB PASS)
- Module6 / 交付计划 (DeliveryPlan): 14,063行 (Dev vs Src PASS, Dev vs DB PASS, Src vs DB PASS)
- Module6 / 车辆日志 (VehicleLog): 134行 (Dev vs Src PASS, Dev vs DB PASS, Src vs DB PASS)
- Module6 / 卡车使用日志 (TruckUsageLog): 132行 (Dev vs Src PASS, Dev vs DB PASS, Src vs DB PASS)

### 5.2 区间性能总结
| 指标 | Dev | Src | DB | 最佳提升 |
|------|-----|-----|-----|----------|
| 区间总时间 | 218.5分钟 | 52.4分钟 | 27.4分钟 | 87.4% |
| M1 订单生成平均耗时/天 | ~387.1秒 | ~62.2秒 | ~64.2秒 | 83.9% |
| M3 净需求计算平均耗时/天 | ~347.1秒 | ~57.8秒 | ~27.5秒 | 92.1% |
| M5 部署规划平均耗时/天 | ~564.2秒 | ~186.2秒 | ~65.0秒 | 88.5% |

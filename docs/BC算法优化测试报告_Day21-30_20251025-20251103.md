...
| **Src** | 304秒 (5.1分钟) | 30.4秒 |
| **DB** | 162秒 (2.7分钟) | 16.2秒 |

### 2.2 性能提升比例
| 对比项 | 加速倍数 | 时间减少百分比 |
|--------|----------|----------------|
| **Src vs Dev** | **3.22x** | 68.9% |
| **DB vs Dev** | **6.04x** | 83.5% |
| **DB vs Src** | **1.88x** | 46.7% |

### 2.3 各模块平均耗时对比（秒/天）
| 模块 | Dev | Src | DB | Src加速 | DB加速 |
|------|-----|-----|-----|---------|--------|
| **M1 订单生成** | ~18.4 | ~6.4 | ~5.9 | 2.87x | 3.12x |
| **M3 净需求计算** | ~22.6 | ~5.8 | ~2.2 | 3.90x | 10.27x |
| **M5 部署规划** | ~52.8 | ~15.6 | ~5.9 | 3.38x | 8.95x |
...
| M3 净需求计算 | ~21.0 | ~5.0 | ~2.0 |
| M5 部署规划 | ~49.0 | ~15.0 | ~5.0 |
| M6 物流执行 | ~1.0 | ~1.0 | ~1.0 |
...
| 指标 | Dev | Src | DB | 最佳提升 |
|------|-----|-----|-----|----------|
| 区间总时间 | 16.3分钟 | 5.1分钟 | 2.7分钟 | 83.5% |
| M1 订单生成平均耗时/天 | ~18.4秒 | ~6.4秒 | ~5.9秒 | 67.9% |
| M3 净需求计算平均耗时/天 | ~22.6秒 | ~5.8秒 | ~2.2秒 | 90.3% |
| M5 部署规划平均耗时/天 | ~52.8秒 | ~15.6秒 | ~5.9秒 | 88.8% |

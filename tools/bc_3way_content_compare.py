...
# -*- coding: utf-8 -*-
"""
bc_3way_content_compare.py

三版本（Dev/Src/DB）逐日逐Sheet内容级对比工具 — BC_S5 版本。
...
输出:
  - JSON格式的全量对比结果 (tools/bc_3way_content_results_full.json)
  - 控制台摘要

Usage:
    python tools/bc_3way_content_compare.py [--days 1-10] [--modules module1]
"""
...
def main():
    parser = argparse.ArgumentParser(description="BC_S5 3-way content comparison")
    ...
    parser.add_argument("--output", type=str, default=None,
                        help="Output JSON path (default: tools/bc_3way_content_results_full.json)")

# FEM S2 KPI analysis - run 20260630-1523-fem-s2-kpi

- level: scenario
- project: fem-cs-test
- scenario: s2-fem-hpfd-network-0386
- run_id: db_s2-fem-hpfd-network-0386_20260630_142529
- database: fem_test
...
## Headline results
- ToF Feb 2026: 98.7% (162,390/164,463)
- ToF Mar 2026: 97.9% (111,519/113,952)
- DFC Feb 2026 (all DCs): 35.0 days (inv 133,143 / 3,807.7 per day)
- DFC Mar 2026 (all DCs): 42.6 days (inv 76,471 / 1,794.0 per day)
...
- Production total time Mar 2026: 64.2 hr (prod 52.7 + CO 11.5; CO share 17.9%)
- APQ overall: 5.769 MSU/run (total MSU 201.9 / 35 runs)
- PKG CO/MSU: 0.1535 (31 CO / 201.9 MSU)
- CONV CO/MSU: 0.0446 (9 CO / 201.9 MSU)
...
- APQ note: material(s) 80799574 are the line's base product (already mounted at sim start), so their campaigns carry no logged change-over but ARE counted as runs via the contiguous-campaign rule (2 base-product campaign(s) in scope). They carry 90.9 MSU (45% of volume). Headline APQ uses 35 runs = 33 change-over-started + 2 base-product campaign(s); change-over-started runs alone average ~3.365 MSU/run.
- DFC month-end dates: Mar 2026=2026-03-31, Feb 2026=2026-02-28; both months have full 30-day forward windows.

## Outputs
- workbook: fem-cs-test_result_summary_20260630-1523-fem-s2-kpi.xlsx

...
| **Src** | 2109秒 (35.1分钟) | 210.9秒 |
| **DB** | 1074秒 (17.9分钟) | 107.4秒 |

### 2.2 性能提升比例
| 对比项 | 加速倍数 | 时间减少百分比 |
|--------|----------|----------------|
| **Src vs Dev** | **6.13x** | 83.7% |
| **DB vs Dev** | **12.04x** | 91.7% |
| **DB vs Src** | **1.96x** | 49.1% |

### 2.3 各模块平均耗时对比（秒/天）
| 模块 | Dev | Src | DB | Src加速 | DB加速 |
|------|-----|-----|-----|---------|--------|
| **M1 订单生成** | ~381.2 | ~42.6 | ~37.6 | 8.95x | 10.14x |
| **M3 净需求计算** | ~344.8 | ~47.8 | ~20.3 | 7.21x | 16.99x |
| **M5 部署规划** | ~537.6 | ~106.5 | ~38.2 | 5.05x | 14.07x |

### 2.4 每日详细耗时（区间最后一天）
#### Day 50 (2026-02-02) 各模块耗时（秒）
| 模块 | Dev | Src | DB |
|------|-----|-----|-----|
| M1 订单生成 | ~378.0 | ~41.0 | ~37.0 |
| M3 净需求计算 | ~342.0 | ~46.0 | ~21.0 |
| M5 部署规划 | ~549.0 | ~102.0 | ~36.0 |
| M6 物流执行 | ~4.0 | ~2.0 | ~2.0 |
...
| 指标 | Dev | Src | DB | 最佳提升 |
|------|-----|-----|-----|----------|
| 区间总时间 | 215.5分钟 | 35.1分钟 | 17.9分钟 | 91.7% |
| M1 订单生成平均耗时/天 | ~381.2秒 | ~42.6秒 | ~37.6秒 | 90.1% |
| M3 净需求计算平均耗时/天 | ~344.8秒 | ~47.8秒 | ~20.3秒 | 94.1% |
| M5 部署规划平均耗时/天 | ~537.6秒 | ~106.5秒 | ~38.2秒 | 92.9% |

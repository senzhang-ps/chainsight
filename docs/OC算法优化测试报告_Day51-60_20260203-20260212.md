...
| **DB** | 1625秒 (27.1分钟) | 162.5秒 |

### 2.2 性能提升比例
| 对比项 | 加速倍数 | 时间减少百分比 |
|--------|----------|----------------|
| **Src vs Dev** | **4.03x** | 75.2% |
| **DB vs Dev** | **7.63x** | 86.9% |
| **DB vs Src** | **1.89x** | 47.2% |

### 2.3 各模块平均耗时对比（秒/天）
| 模块 | Dev | Src | DB | Src加速 | DB加速 |
|------|-----|-----|-----|---------|--------|
| **M1 订单生成** | ~362.7 | ~63.1 | ~64.1 | 5.75x | 5.66x |
| **M3 净需求计算** | ~337.8 | ~56.2 | ~26.7 | 6.01x | 12.65x |
| **M5 部署规划** | ~508.5 | ~167.6 | ~52.7 | 3.03x | 9.65x |

### 2.4 每日详细耗时（区间最后一天）
#### Day 60 (2026-02-12) 各模块耗时（秒）
| 模块 | Dev | Src | DB |
|------|-----|-----|-----|
| M1 订单生成 | ~347.0 | ~64.0 | ~66.0 |
| M3 净需求计算 | ~337.0 | ~55.0 | ~27.0 |
| M5 部署规划 | ~517.0 | ~164.0 | ~52.0 |
| M6 物流执行 | ~2.0 | ~2.0 | ~1.0 |
...
|------|------|---------|---------|--------|------------|-----------|-----------|
| Module1 | 订单日志 (OrderLog) | 176,386 | 176,386 | 176,386 | PASS | PASS | PASS |
| Module1 | 发货日志 (ShipmentLog) | 20,496 | 20,496 | 20,496 | PASS | PASS | PASS |
| Module1 | 削减日志 (CutLog) | 20,496 | 20,496 | 20,496 | PASS | PASS | PASS |
| Module1 | 每日汇总 (Summary) | 10 | 10 | 10 | PASS | PASS | PASS |
| Module3 | 净需求 (NetDemand) | 8,605 | 8,605 | 8,605 | PASS | PASS | PASS |
| Module4 | 生产计划 (ProductionPlan) | 77 | 77 | 77 | PASS | PASS | PASS |
| Module4 | 超容量报告 (CapacityExceed) | 86 | 86 | 86 | PASS | PASS | PASS |
| Module4 | 换型日志 (ChangeoverLog) | 57 | 57 | 57 | PASS | PASS | PASS |
| Module5 | 部署计划 (DeploymentPlan) | 423,213 | 423,213 | 423,213 | PASS | PASS | PASS |
| Module5 | 未满足日志 (UnfulfilledLog) | 28,101 | 28,101 | 28,101 | PASS | PASS | PASS |
| Module5 | 库存日志 (StockOnHandLog) | 51,090 | 51,090 | 51,090 | PASS | PASS | PASS |
| Module5 | 验证 (Validation) | 82,000 | 82,000 | 82,000 | PASS | PASS | PASS |
| Module6 | 交付计划 (DeliveryPlan) | 8,829 | 8,829 | 8,829 | PASS | PASS | PASS |
| Module6 | 车辆日志 (VehicleLog) | 132 | 132 | 132 | PASS | PASS | PASS |
| Module6 | 卡车使用日志 (TruckUsageLog) | 128 | 128 | 128 | PASS | PASS | PASS |
...
|------|------|---------|---------|--------|------------|-----------|-----------|
| Day 51 | 2026-02-03 | 17,666 | 17,666 | 17,666 | PASS | PASS | PASS |
| Day 52 | 2026-02-04 | 17,665 | 17,665 | 17,665 | PASS | PASS | PASS |
| Day 53 | 2026-02-05 | 17,665 | 17,665 | 17,665 | PASS | PASS | PASS |
| Day 54 | 2026-02-06 | 17,665 | 17,665 | 17,665 | PASS | PASS | PASS |
| Day 55 | 2026-02-07 | 17,665 | 17,665 | 17,665 | PASS | PASS | PASS |
| Day 56 | 2026-02-08 | 17,665 | 17,665 | 17,665 | PASS | PASS | PASS |
| Day 57 | 2026-02-09 | 17,665 | 17,665 | 17,665 | PASS | PASS | PASS |
| Day 58 | 2026-02-10 | 17,598 | 17,598 | 17,598 | PASS | PASS | PASS |
| Day 59 | 2026-02-11 | 17,572 | 17,572 | 17,572 | PASS | PASS | PASS |
| Day 60 | 2026-02-12 | 17,560 | 17,560 | 17,560 | PASS | PASS | PASS |
| **合计** | | **176,386** | **176,386** | **176,386** | **10/10天PASS** | **10/10天PASS** | **10/10天PASS** |
...
| **合计** | | **20,496** | **20,496** | **20,496** | **10/10天PASS** | **10/10天PASS** | **10/10天PASS** |
...
| **合计** | | **8,605** | **8,605** | **8,605** | **10/10天PASS** | **10/10天PASS** | **10/10天PASS** |
...
| **合计** | | **77** | **77** | **77** | **10/10天PASS** | **10/10天PASS** | **10/10天PASS** |
...
| **合计** | | **423,213** | **423,213** | **423,213** | **10/10天PASS** | **10/10天PASS** | **10/10天PASS** |
...
| **合计** | | **28,101** | **28,101** | **28,101** | **10/10天PASS** | **10/10天PASS** | **10/10天PASS** |
...
| **合计** | | **8,829** | **8,829** | **8,829** | **10/10天PASS** | **10/10天PASS** | **10/10天PASS** |
...
| Day 59 | 2026-02-11 | 12 | 12 | 12 | PASS | PASS | PASS |
| Day 60 | 2026-02-12 | 13 | 13 | 13 | PASS | PASS | PASS |
| **合计** | | **128** | **128** | **128** | **10/10天PASS** | **10/10天PASS** | **10/10天PASS** |
...
验证覆盖（本区间）：
- Module1 / 订单日志 (OrderLog): 176,386行 (Dev vs Src PASS, Dev vs DB PASS, Src vs DB PASS)
- Module1 / 发货日志 (ShipmentLog): 20,496行 (Dev vs Src PASS, Dev vs DB PASS, Src vs DB PASS)
- Module1 / 削减日志 (CutLog): 20,496行 (Dev vs Src PASS, Dev vs DB PASS, Src vs DB PASS)
- Module1 / 每日汇总 (Summary): 10行 (Dev vs Src PASS, Dev vs DB PASS, Src vs DB PASS)
- Module3 / 净需求 (NetDemand): 8,605行 (Dev vs Src PASS, Dev vs DB PASS, Src vs DB PASS)
- Module4 / 生产计划 (ProductionPlan): 77行 (Dev vs Src PASS, Dev vs DB PASS, Src vs DB PASS)
- Module4 / 超容量报告 (CapacityExceed): 86行 (Dev vs Src PASS, Dev vs DB PASS, Src vs DB PASS)
- Module4 / 换型日志 (ChangeoverLog): 57行 (Dev vs Src PASS, Dev vs DB PASS, Src vs DB PASS)
- Module5 / 部署计划 (DeploymentPlan): 423,213行 (Dev vs Src PASS, Dev vs DB PASS, Src vs DB PASS)
- Module5 / 未满足日志 (UnfulfilledLog): 28,101行 (Dev vs Src PASS, Dev vs DB PASS, Src vs DB PASS)
...
- Module6 / 交付计划 (DeliveryPlan): 8,829行 (Dev vs Src PASS, Dev vs DB PASS, Src vs DB PASS)
- Module6 / 车辆日志 (VehicleLog): 132行 (Dev vs Src PASS, Dev vs DB PASS, Src vs DB PASS)
- Module6 / 卡车使用日志 (TruckUsageLog): 128行 (Dev vs Src PASS, Dev vs DB PASS, Src vs DB PASS)

### 5.2 区间性能总结
| 指标 | Dev | Src | DB | 最佳提升 |
|------|-----|-----|-----|----------|
| 区间总时间 | 206.8分钟 | 51.3分钟 | 27.1分钟 | 86.9% |
| M1 订单生成平均耗时/天 | ~362.7秒 | ~63.1秒 | ~64.1秒 | 82.6% |
| M3 净需求计算平均耗时/天 | ~337.8秒 | ~56.2秒 | ~26.7秒 | 92.1% |
| M5 部署规划平均耗时/天 | ~508.5秒 | ~167.6秒 | ~52.7秒 | 89.6% |

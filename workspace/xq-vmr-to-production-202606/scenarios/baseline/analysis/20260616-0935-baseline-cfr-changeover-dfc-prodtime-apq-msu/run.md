# Analysis run 20260616-0935-baseline-cfr-changeover-dfc-prodtime-apq-msu

- **Level:** scenario (baseline)
- **Project:** xq-vmr-to-production-202606
- **DB run_id:** db_baseline_20260615_221037
- **config_name:** baseline
- **Generated:** 2026-06-16 09:35
...
- APQ = sum(con_planned_qty) / production-run count. A run = a module4_output_productionplan row with non-null changeover_id (begins with a changeover); null-changeover continuation rows are not counted. Overall 1595.5 units/run = 10059660 / 6305. By line and by material.
- Wash count / MSU = wash count / MSU per line. Wash count = changeover events with id in 2, 3 (module4_output_changeoverlog). MSU = sum(con_planned_qty x SU factor / 1000) over the line's materials. Overall 0.480 washes/MSU = 5519 / 11503.6 MSU.

## Data lineage
- Category source: databricks — fresh Databricks pull (category_en).
- Category coverage: databricks 236/384; enriched 340/384.
- Category resolution by order qty: databricks 51.5%, line-inferred 39.7%, unmapped 8.8%.
...
- SU factor source: SUF workbook workspace\xq-vmr-to-production-202606\scenarios\baseline\config\SUF for XQ HC ChainSight.xlsx (primary, 191 materials) + Databricks su_factor_for_buom fallback (102 materials); 90 missing. Overlapping sources agree to ~0.05%.
- Unmapped-line materials: 21359277, 21368921, 21377834, 21479013, 21479014, 21483803, 21488493.
- Unmapped-category materials: 20209743, 20218590, 21156898, 21171678, 21178234, 21178241, 21184776, 21184777, 21200191, 21205101, 21316101, 21319824, 21325952, 21334484, 21334685, 21344138, 21359277, 21366576, 21366578, 21368921, 21372947, 21372948, 21372958, 21377834, 21387644, 21403972, 21420779, 21425608, 21447907, 21457337, 21461977, 21469015, 21469016, 21479013, 21479014, 21483803, 21488493, 21506954, 21512422, 21517035, 21517036, 21554083, 21559781, 90450569.

## Outputs
- `xq-vmr-to-production-202606_result_summary_20260616-0935-baseline-cfr-changeover-dfc-prodtime-apq-msu.xlsx`
- `analysis.html`

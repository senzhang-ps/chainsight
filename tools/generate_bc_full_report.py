...
def generate_full_report(
    ...
    # ── Section 1: 测试概述 ──
    a(f"# ChainSight 供应链仿真系统 BC算法优化测试报告 (完整版 Day 01-{n:02d})")
    a("")
    a("## 1. 测试概述")
    a("")
    a("### 1.1 测试目的")

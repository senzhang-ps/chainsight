...
- Config target: assemble workbook at
  `workspace/sdc-space-rccp-simulation-202605/scenarios/baseline-current-params-should-be-rccp-otd/config/baseline_current_params_should_be_rccp.xlsx`
...
- Scope file:
  `workspace/sdc-space-rccp-simulation-202605/scenarios/baseline-current-params-should-be-rccp-otd/scope.yaml`
- Config directory:
  `workspace/sdc-space-rccp-simulation-202605/scenarios/baseline-current-params-should-be-rccp-otd/config/`
- Imported config workbook:
  `workspace/sdc-space-rccp-simulation-202605/scenarios/baseline-current-params-should-be-rccp-otd/config/baseline_current_params_should_be_rccp.xlsx`
- Imported companion CSV:
  `workspace/sdc-space-rccp-simulation-202605/scenarios/baseline-current-params-should-be-rccp-otd/config/M3_SafetyStock.csv`
- Results directory:
  `workspace/sdc-space-rccp-simulation-202605/scenarios/baseline-current-params-should-be-rccp-otd/results/`
- Analysis file:
  `workspace/sdc-space-rccp-simulation-202605/scenarios/baseline-current-params-should-be-rccp-otd/analysis.md`
...
| **DB vs Dev** | **2.28x** | 56.1% |
| **DB vs Src** | **1.32x** | 24.2% |

### 2.3 各模块平均耗时对比（秒/天）
| 模块 | Dev | Src | DB | Src加速 | DB加速 |
|------|-----|-----|-----|---------|--------|
| **M1 订单生成** | ~18.1 | ~12.0 | ~15.6 | 1.51x | 1.16x |
| **M3 净需求计算** | ~21.8 | ~8.4 | ~4.5 | 2.60x | 4.84x |
| **M5 部署规划** | ~56.9 | ~32.4 | ~15.5 | 1.76x | 3.67x |

### 2.4 每日详细耗时（区间最后一天）
#### Day 80 (2025-12-23) 各模块耗时（秒）
| 模块 | Dev | Src | DB |
|------|-----|-----|-----|
| M1 订单生成 | ~17.0 | ~12.0 | ~15.0 |
| M3 净需求计算 | ~22.0 | ~8.0 | ~5.0 |
| M5 部署规划 | ~57.0 | ~35.0 | ~16.0 |
| M6 物流执行 | ~2.0 | ~2.0 | ~2.0 |
...
| 指标 | Dev | Src | DB | 最佳提升 |
|------|-----|-----|-----|----------|
| 区间总时间 | 17.9分钟 | 10.4分钟 | 7.9分钟 | 56.1% |
| M1 订单生成平均耗时/天 | ~18.1秒 | ~12.0秒 | ~15.6秒 | 33.7% |
| M3 净需求计算平均耗时/天 | ~21.8秒 | ~8.4秒 | ~4.5秒 | 79.4% |
| M5 部署规划平均耗时/天 | ~56.9秒 | ~32.4秒 | ~15.5秒 | 72.8% |
